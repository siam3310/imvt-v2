    ...
    return (
        <div className="w-full h-full max-h-[100dvh] overflow-scroll">
            <div className="flex gap-y-10 flex-col min-h-[100dvh] h-fit items-center justify-start p-6">
                ...
                <Input type="text" onChange={(e) => setQuery(e.target.value)} value={query} placeholder="Search" className=" outline-none max-w-[600px] border-none dark:text-black dark:bg-white rounded-3xl" />
