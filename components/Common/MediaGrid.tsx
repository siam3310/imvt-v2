                ...
                >
                  ...
                  >
                    <div className='absolute flex justify-start items-center flex-wrap gap-2 top-3 left-3 z-[3]'>
                      ...
                      {post.releaseDate && (
                        <span className='bg-green-500 text-white py-[2px] px-1 text-[0.8rem] rounded-md whitespace-nowrap flex items-center'>
                          {post.releaseDate}
                        </span>
                      )}
                    </div>
          ...
          {Array(35)
            ...
            .map((_, i) => (
              <div
                key={i}
                style={{ flexBasis: basis }}
                className={`pl-5 relative min-w-0 shrink-0 grow-0 basis-1/2 sm:basis-1/4 md:basis-1/5 lg:basis-1/6 xl:basis-1/8 h-fit`}
              >
