        ...
        <div className="group clickable">
            ...
            {type !== "people" && <Popover>
                <PopoverTrigger asChild>
                    <Button variant={"link"} className='w-full absolute bottom-8 left-0 z-[10] flex items-start justify-end p-2'><span className='p-1 border-black border bg-white text-black w-fit rounded-tl-xl text-[0.8rem] whitespace-nowrap '>{watchlistType ? watchListNames[watchlistType] : <><PlusCircle size={20} strokeWidth={2} absoluteStrokeWidth /></>}</span></Button>
                </PopoverTrigger>
