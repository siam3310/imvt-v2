...
const SelectAnimeDrawer = ({ children, animeQuery }: { children: React.ReactNode, animeQuery: string }) => {
    ...
    return (
        <Drawer>
            ...
            <DrawerContent className="overflow-hidden max-h-[80dvh] z-[11111111111111111]">
                <DrawerHeader><DrawerTitle className="text-center text-xl">Select the Anime</DrawerTitle></DrawerHeader>
