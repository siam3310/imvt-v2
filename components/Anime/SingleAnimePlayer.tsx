...
import { GetAnimebyId, GetAnimeStreamingData } from '@/graphql/queries/GetAnime.gql'

const SingleMediaPlayer = ({ id }: { id: string }) => {
                        ...
                        <ScrollArea className='w-full h-full'>
                            ...
                            {(!loading && isAnimePlayer && !streamingLoading) && streamingData[serverNumber - 1]?.sources?.length > 0 && <MediaPlayer
                                media={{
                                    ...
                                    thumbnail: animeData?.zoroEpisodes ? animeData?.zoroEpisodes[episodeNumber - 1]?.image : `https://via.placeholder.com/300`,
