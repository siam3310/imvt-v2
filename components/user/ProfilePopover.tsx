        ...
        <Popover>
            ...
            <PopoverContent className="w-80 z-[11111111111111]">
                <div className="grid gap-2">
                    <Link href="/my-profile" className="w-full justify-start items-start flex gap-x-2">
                        <Image
                        ...
                        <div className="flex flex-col items-start justify-start max-w-[75%]">
                            <h2 className="text-lg font-semibold whitespace-nowrap overflow-hidden text-ellipsis w-full">{userData?.name}</h2>
                            <h2 className="text-md font-light whitespace-nowrap overflow-hidden text-ellipsis w-full">{userData?.email}</h2>
                        </div>
                    </Link>
