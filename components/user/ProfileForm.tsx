  ...
  return (
    <Form {...form}>
      <form
        ...
        className='flex flex-col md:flex-row-reverse gap-3 items-start justify-center pb-[150px] sm:pb-8 sm:pt-5'
      >
                ...
                <FormControl>
                  <>
                        ...
                        <Image
                          ...
                          src={
                            field?.value && field?.value !== ''
                              ? field?.value
                              : `data:image/${shimmerBlurDataUrl(100, 100)}`
                          }
                          width={100}
                          height={100}
                          loading={'eager'}
                    ...
                    <Input
                      ...
                      onChange={
                        inputLoading && !field.value ? null : field.onChange
                      }
                      type='text'
                      placeholder={
                        inputLoading
        ...
        <div className='w-full flex flex-col space-y-8'>
          ...
          <Button
            disabled={
              ...
              (form.watch().name === userData?.name &&
                form.watch().profile_photo === userData?.profile_photo)
            }
            type='submit'
          >
            {!inputLoading ? (
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button disabled={inputLoading} variant={'destructive'}>
                {!inputLoading ? (
                  'Delete Acccount'
                ) : (
                  <svg
