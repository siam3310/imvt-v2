  ...
  return (
    <div className='sm:hidden absolute bottom-0 z-50 w-full -translate-x-1/2 dark:bg-[#0b0b0b] border-t left-1/2 dark:border-gray-600'>
      <div className='w-full'>
        <div
          className='grid max-w-xs grid-cols-2 gap-1 p-1 mx-auto my-2 dark:bg-[rgb(62,67,75)] rounded-lg dark:border-gray-600'
          role='group'
        >
          <Link
            href='/search'
            className='flex justify-evenly items-center px-5 py-1.5 text-xs font-medium rounded-lg border dark:bg-black dark:border-gray-900 dark:text-white dark:hover:bg-gray-900'
          >
          ...
          <Link
            ...
            className='flex justify-evenly items-center px-5 py-1.5 text-xs font-medium rounded-lg border dark:bg-black dark:border-gray-900 dark:text-white dark:hover:bg-gray-900'
          >
            <Compass color='rgb(107 114 128 / 1)' />
            Explore
          </Link>
        </div>
      </div>
      ...
      <div className='grid h-full max-w-lg grid-cols-5 mx-auto'>
        <Link
          ...
          type='button'
          className='inline-flex flex-col items-center justify-center p-4 hover:bg-gray-50 dark:hover:bg-gray-900 group'
        >
        ...
        >
          ...
          <span className='text-sm text-[rgb(107,114,128,1)] whitespace-nowrap'>
            Live TV
          </span>
        </Link>
        ...
        <ProfilePopover userData={userData}>
          <button className='w-full h-full p-1 flex items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-900'>
            <span className='flex flex-col items-center justify-center'>
              <svg
                className='text-[rgb(107,114,128,1)]'
